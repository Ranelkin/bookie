...
export async function saveOrganizationSettings(
  ...
  const db = await getDb();
  await db.execute(
    `INSERT INTO settings_organization (id, name, country, address, street, postal_code, city, email, phone_number, registering_id, bank_name, bank_iban, bank_account_holder, vatin, website, default_locale, default_legal_country, owner_birthday_date)
		 ...
		 owner_birthday_date = excluded.owner_birthday_date,
